...
class ZSP_Plugin_Autoloader{
	...
	*/
	public function autoloadEngine( $class ){
		$prefix   = zsp_config( 'namespace' ) .'\\';
		$base_dir = ZSP_PATH .'engine/';
	...
	*/
	public function autoloadComponents( $class ){
		$prefix   = zsp_config( 'namespace' ) .'\\Component\\';
		$base_dir = ZSP_PATH .'components/';
